        ...
        <AnimatePresence>
            ...
            >
                ...
                >
                    ...
                    >
                        <div>
                            <h3 className="text-gray-500 mb-1 text-[18px] font-medium">Order Date</h3>
                            <p className="font-medium text-gray-800">{formatDate(order.time)}</p>
                        </div>
                        <div>
                            <h3 className="text-gray-500 mb-1 text-[18px] font-medium">Payment Method</h3>
                            <p className="font-medium text-gray-800">{order.payment_method}</p>
                        </div>
                        <div>
                            <h3 className="text-gray-500 mb-1 text-[18px] font-medium">Order Status</h3>
                            <p className="font-medium text-gray-800">{order.order_status}</p>
                        </div>
                        <div>
                            <h3 className="text-gray-500 mb-1 text-[18px] font-medium">Payment Status</h3>
