        ...
        >
          ...
          >
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              onClick={onClose}
              className="flex-1 border-2 border-red-200 text-red-500 rounded-2xl grid place-items-center text-[18px] font-medium py-3 cursor-pointer hover:bg-red-50 transition-colors"
            >
              Cancel
            </motion.div>
            <motion.div
              ...
              className={`
                flex-1 rounded-2xl grid place-items-center font-medium text-[18px] py-3 cursor-pointer text-white
