                      ...
                      {discountData?.map((offer, index) => (
                        <tr key={offer.id} className="">
                          <td className="px-3 py-2">
                            <p className="font-medium ml-6 text-[15px]">
                              {index+1}
                            </p>
                          </td>
                          <td className="px-3 py-2">
                            <div className="font-medium text-gray-900 text-[18px] flex gap-4">
                              {offer?.category?.name?
                              ...
                              <span>
                            <p className="font-medium text-[15px] opacity-45">{offer?.category?.name?'product':'category'}</p>
                              {offer?.name}
                          ...
                          <td className="px-3 py-2">
                            <div className={`font-medium ${offer?.category?.name?'text-green-700':'text-red-700'} text-[15px]`}>
