          ...
          <div className="">
            ...
            <table className="w-full border-collapse rounded-full mt-5">
              <thead className="py-10">
                <tr className="bg-[linear-gradient(to_right,#fbdcc9,#fbf5f2)] font-mono text-[18px] rounded-full text-[#00000070]">
              ...
              <tbody>
                ...
                (
                  <tr key={user._id} className="border-b">
                    ...
                    <td className="py-2 px-4 text-[18px] opacity-55">{user.email}</td>
