            ...
            <div className="container w-[105%] h-full pt-[56px] my-8 relative">
                <div className="w-full h-full bg-[radial-gradient(circle_at_10%_10%,_rgb(222,255,247)_0%,rgba(255,0,0,0)_100%);] rounded-tl-[65px] flex justify-center relative">
                    ...
                    >
                        ...
                        <p className="text-[18px] -translate-y-[2px] font-medium">Coupons</p>
                    </div>
                                ...
                                <div className="flex flex-col gap-6">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <input
                                            ...
                                            className="outline-none w-full py-3 px-5 bg-[linear-gradient(45deg,#AAEACD,#f5efef)] rounded-full text-[18px] uppercase transition-all focus:shadow-lg"
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <div className="flex gap-2">
                                            <button
                                                ...
                                                className={`flex-1 py-3 px-5 rounded-full text-[18px] transition-all ${formState.discountType === 'percentage'
                                            ...
                                            <button
                                                ...
                                                className={`flex-1 py-3 px-5 rounded-full text-[18px] transition-all ${formState.discountType === 'fixed'
                                                        ? 'bg-[linear-gradient(45deg,#AAEACD,#f5efef)] font-medium'
                                                        : 'bg-white border-2 border-dashed border-gray-300 hover:border-green-500 hover:text-green-500'
                                                    }`}
                                            >
                                ...
                                <div className="flex flex-col gap-6">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <textarea
                                            ...
                                            onChange={handleInputChange}
                                            className="outline-none w-full py-3 px-5 bg-[linear-gradient(45deg,#AAEACD,#f5efef)] rounded-[20px] text-[18px] min-h-[100px] transition-all focus:shadow-lg"
