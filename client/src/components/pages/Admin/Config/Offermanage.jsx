      ...
      <div className="container w-[105%] h-full pt-[56px] my-8 relative ">
        <div className="w-full min-h-screen bg-[radial-gradient(circle_at_10%_10%,_rgb(222,255,247)_0%,rgba(255,0,0,0)_100%);] rounded-tl-[65px] flex justify-center relative">
          ...
          >
            ...
            <p className="text-[18px] -translate-y-[2px] font-medium">Offers</p>
          </div>
          ...
          <div className="w-full">
            ...
            <div className="max-w-[800px] mx-auto mb-10">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <select
                      ...
                      className="outline-none w-full py-3 px-5 rounded-full text-[18px] transition-all focus:shadow-lg custom-selectero"
                    >
                  ...
                  {formState.offerFor === "Product" && (
                    <div className="flex flex-col gap-1">
                      ...
                      <button
                        ...
                        className="w-full py-3 px-5 bg-white border-2 border-dashed border-gray-300 rounded-full text-[18px] hover:border-green-500 hover:text-green-500 transition-all flex items-center justify-center gap-2"
                      >
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className="outline-none w-full py-3 px-5 bg-[linear-gradient(45deg,#AAEACD,#f5efef)] rounded-full text-[18px] transition-all focus:shadow-lg custom-selectero"
                    >
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className={`flex-1 py-3 px-5 rounded-full text-[18px] transition-all ${
                ...
                <div className="flex flex-col gap-6">
                  {formState.offerType === "Discount" && (
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="relative">
                        <span className="absolute left-5 top-1/2 -translate-y-1/2 text-[18px] opacity-70">
                          {formState.discountType === 'percentage' ? '%' : '₹'}
                        </span>
                        <input
                          name="discountValue"
                          ...
                          className="outline-none w-full py-3 pl-10 pr-5 bg-[linear-gradient(45deg,#AAEACD,#f5efef)] rounded-full text-[18px] transition-all focus:shadow-lg"
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        type="number"
                        step="0.1"
                        className="outline-none w-full py-3 px-5 bg-[linear-gradient(45deg,#AAEACD,#f5efef)] rounded-full text-[18px] transition-all focus:shadow-lg"
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className="outline-none w-[120px] py-3 px-5 rounded-full text-[18px] transition-all focus:shadow-lg custom-selectero"
                      >
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="relative">
                      <span className="absolute left-5 top-1/2 -translate-y-1/2 text-[18px] opacity-70">₹</span>
                      <input
                        name="maxAmount"
              ...
              <button
                ...
                className="px-0 py-[15px] bg-[linear-gradient(to_left,#8CC850,#1F9C64)] text-[18px] rounded-full text-white font-medium mt-8 w-full transition-transform hover:scale-105"
              >
                Update Offer
              </button>
            </div>
