      ...
      <div className="w-full h-full flex">
        ...
        <div className="flex-grow-[3] max-w-[40%] h-full pt-3 pl-20">
          <div className="w-full h-full flex flex-col gap-5">
            ...
            {/* input for feedback */}
            <input
              className="w-full pb-10 py-3 px-5 bg-[linear-gradient(45deg,#f5efef,#f5efef)] rounded-2xl text-[18px]"
              type="text"
            ...
            {/* submit button */}
            <button className="px-16 py-[15px] bg-[linear-gradient(to_left,#0bc175,#ffb31e)] text-[18px] rounded-full text-white font-medium mt-2 w-full max-w-[300px]">
              Post your feedback
            </button>
          </div>
        </div>
