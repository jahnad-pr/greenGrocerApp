                        ...
                        <div className="w-[45%] h-full flex flex-col">
                            ...
                            {productsData.length > 0 && (
                                <span className="relative">
                                    {showRelateCount !== 0 &&
                                        <div onClick={() => setShowRelateCount(showRelateCount - 3)} className="w-12 hover:opacity-55 cursor-pointer h-12 bg-[#afa57046] absolute top-1/2 -left-20 z-10 justify-center items-center flex rounded-full">
                                    ...
                                    {productsData.length > 3 && (productsData.length > showRelateCount + 3) &&
                                        <div onClick={() => setShowRelateCount(showRelateCount + 3)} className="w-12 h-12 bg-[#afa57046] cursor-pointer hover:opacity-55 absolute top-1/2 -right-20 rotate-180 z-10 justify-center items-center flex rounded-full">
                                            <i className="ri-arrow-left-s-fill text-[35px] -translate-x-[1px]"></i>
                                        </div>
