              ...
              {/* other contents */} <span className="w-full h-full flex sm:px-20 px-12 2xl:px-40 flex-col lg:flex-row ">
                ...
                <p className="text-[23px] mb-5 opacity-55">
                  ...
                  <input placeholder="Shalu!23"
                    ...
                    disabled={!isEditMode}
                  className="max-w-[100%] md:max-w-[220px] 2xl:max-w-[300px] outline-none px-6 text-[18px] bg-[#6b817325] h-12 rounded-[18px] rounded-br-[100px] flex" type="text" />
                  </span>
                  ...
                  type="text"
                  disabled={!isEditMode}
                  className="max-w-[100%] md:max-w-[220px] 2xl:max-w-[300px] outline-none px-6 text-[18px] bg-[#6b817325] w-96 h-12 rounded-[18px] rounded-br-[100px] flex" />
                  </span>
                  </span>
                  ...
                  disabled={!isEditMode}
                  className="max-w-[100%] md:max-w-[220px] 2xl:max-w-[300px] bg-[#6b817325] outline-none px-6 text-[18px] w-96 h-12 rounded-[18px] rounded-br-[100px] flex" type="text" />
                  </span>
                  <span className="inline-flex flex-col md:pl-5">
                  ...
                  disabled={!isEditMode}
                  name="gender"
                  className="max-w-[100%] md:max-w-[220px] 2xl:max-w-[300px] custom-selecto bg-[#6b817325] outline-none px-6 text-[18px] w-96 h-12 rounded-[18px] rounded-br-[100px] flex" type="text" >
