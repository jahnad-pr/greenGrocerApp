      ...
      <div className="w-[96%] h-full">
        <div className="w-full h-full px-[500px] flex flex-col items-center gap-5">
          ...
          <div className="flex w-full gap-10">
           {/* name */}
          <input className=' w-full  py-3 px-5 bg-[linear-gradient(45deg,#f5efef,#f5efef)] rounded-full text-[18px]' type="text" placeholder='Full Name' />
            {/* email */}
            <input className='w-full py-3 px-5 bg-[linear-gradient(45deg,#f5efef,#f5efef)] rounded-full text-[18px]' type="text" placeholder='Email' />
            {/* phone */}
            <input className='w-full  py-3 px-5 bg-[linear-gradient(45deg,#f5efef,#f5efef)] rounded-full text-[18px]'  type="text" placeholder='Phone' />

          </div>

            {/* feedback input */}
          <div className="bg-[linear-gradient(45deg,#f5efef,#f5efef)] w-full h-auto rounded-[35px] pb-20 pt-4 px-4 text-[20px]">
            <input className='w-full outline-none  py-3 px-5 text-[18px] bg-transparent'  type="text" placeholder='Phone' />
          </div>

          {/* button proced */}

          <button className="px-16 py-[15px] bg-[linear-gradient(to_left,#0bc175,#0f45ff)] text-[18px] rounded-full text-white font-medium mt-10 w-full max-w-[300px]">Send feedbacck</button>
